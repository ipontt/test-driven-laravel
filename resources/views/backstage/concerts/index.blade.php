...
<div class="bg-white flex justify-between mx-auto px-2 sm:px-6 lg:px-8">
	<h1 class="max-w-7xl py-4 px-8 text-xl font-light">Your concerts</h1>

	<a href="{{ route('backstage.concerts.create') }}" class="my-3 mr-8 px-4 text-base font-bold text-white rounded-md border border-transparent shadow-sm focus:ring-2 focus:ring-offset-2 focus:outline-none bg-sky-600 hover:bg-sky-700 focus:ring-sky-500 inline-flex items-center">Add a concert</a>
</div>
