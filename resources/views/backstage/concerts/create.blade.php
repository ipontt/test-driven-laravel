						...
						<div class="px-4 py-5 bg-white space-y-6 sm:p-6">
							<div class="grid grid-cols-3 gap-6">
								<div class="col-span-3">
									...
									<input type="text" name="title" id="title" placeholder="The Headliners" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
							...
							<div class="grid grid-cols-3 gap-6">
								<div class="col-span-3">
									...
									<input type="text" name="subtitle" id="subtitle" placeholder="With the Openers (optional)" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
							...
							<div>
								...
								<div class="mt-1">
									<textarea id="additional_information" name="additional_information" rows="3" class="shadow-sm focus:ring-sky-500 focus:border-sky-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="This concert is 19+. (optional)"></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="px-4 py-5 bg-white space-y-6 sm:p-6">
							<div class="grid grid-cols-3 gap-6">
								<div class="col-span-3">
									...
									<input type="date" name="date" id="date" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
							...
							<div class="grid grid-cols-3 gap-6">
								<div class="col-span-3">
									...
									<input type="time" name="time" id="time" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="px-4 py-5 bg-white space-y-6 sm:p-6">
							<div class="grid grid-cols-3 gap-6">
								<div class="col-span-3">
									...
									<input type="text" name="venue" id="venue" placeholder="The Mosh Pit" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
							...
							<div class="grid grid-cols-3 gap-6">
								<div class="col-span-3">
									...
									<input type="text" name="venue_address" id="venue-address" placeholder="500 Example Ave." class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
							...
							<div class="grid grid-cols-3 gap-6">
								<div>
									...
									<input type="text" name="city" id="city" placeholder="Laraville" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
								<div>
									<label for="state" class="block text-sm font-medium text-gray-700">State/Province</label>
									<input type="text" name="state" id="state" placeholder="ON" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
								<div>
									<label for="zip" class="block text-sm font-medium text-gray-700">ZIP</label>
									<input type="text" name="zip" id="zip" placeholder="90210" class="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="grid grid-cols-2 gap-6">
								<div>
									...
									<div class="mt-1 flex rounded-md shadow-sm">
										...
										<input type="text" name="ticket_price" id="ticket-price" placeholder="0.00" pattern="/[0-9]+\.[0-9]{2}/" class="focus:ring-sky-500 focus:border-sky-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
									</div>
								</div>
								<div>
